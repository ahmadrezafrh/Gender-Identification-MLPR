...
def main():
    ...
    print("Start running Linear models.")
    for param in params:
        
        print('model type: Linear SVM')
        print(f'model is {param["balance_priors"][0]}')
        ...
        if param["splits"]=="k-folds":
            ...
            for fold in folds:
                ...
                if param["balance_priors"][0] == 'balanced':
                    model.fit(x_train, y_train, c=param["c_values"], balance=True, pi=param["balance_priors"][1])
                else:
                    model.fit(x_train, y_train, c=param["c_values"])
    ...
    print("End running linear SVM models.\n")
